...
@section('main-content')
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="mt-[80px] sm:mx-auto sm:w-full sm:max-w-sm">
            @if(session('error'))
                <div class="w-full p-2 rounded-lg text-center m-[30px]">
        ...
        <div class="mt-[50px] sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" action="{{ route('login.attempt') }}" method="POST">
                ...
                <div class="mt-[30px]">
                    ...
                    <div class="mt-2">
                        <input id="email" name="email_address" type="email" autocomplete="email" required class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm
